...
<template>
  <article class="container mx-auto text-white overflow-hidden px-8">
    <header class="mb-4 leading-tight">
      <h2 class="text-2xl md:text-3xl font-heading">STARBUCKS<span class="text-2xl ml-4 md:text-3xl font-heading text-work-light">2008 - 2015</span></h2>
    </header>
    <div class="md:mr-8 mt-12 overflow-hidden">
      <section class="flex flex-wrap md:flex-no-wrap md:mr-8" v-observe-visibility="visibilityChanged">
        <div class="md:w-1/2 mb-8">
          <header>
            <h3 class="text-xl font-semi-bold">STARBUCKS.COM<span class="ml-4 opacity-25">AND RELATED MICROSITES</span></h3>
          </header>
          <p>
      ...
      <section>
        <header class="my-12">
          <h3 class="text-xl font-semi-bold">STARBUCKS RETI<span class="opacity-25 ml-4">INSTALLATIONS, KIOSKS</span></h3>
          <span>
        ...
        <div class="flex flex-wrap md:flex-no-wrap">
          <div class="md:w-1/2">
            <h4 class="text-xl font-semi-bold">Magic Chalkboard<span class="ml-4 opacity-25">RETI</span></h4>
            <p class="mt-2">
        ...
        <div class="flex flex-wrap md:flex-no-wrap mt-12 mb-2">
          <div class="md:w-1/2">
            <h4 class="text-xl font-semi-bold">Coffee Passion Wall<span class="ml-4 opacity-25">RETI</span></h4>
            <p class="mt-2">
